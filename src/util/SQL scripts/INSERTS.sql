...
INSERT INTO VENUE VALUES(7,	'Universidad Eafit', 'Carrera 49, Cl. 7 Sur #50', 'EAFIT', 'CO010');
INSERT INTO VENUE VALUES(8,	'Universidad de San Buenaventura', 'Cra. 122 #6-65', 'USB', 'AR204');
INSERT INTO VENUE VALUES(9, 'Universidad Nacional Autónoma de México', 'Av. Universidad 3004, Col, Copilco Universidad, Coyoacán, 04510 Ciudad de México', 'UNAM', 'MX103');
INSERT INTO VENUE VALUES(10, 'Universidad de Guadalajara', 'Av Juárez 976', 'UDG', 'MX050');
...
INSERT INTO COMPETITION (NAME, DESCRIPTION,START_INSCRIPTION, END_INSCRIPTION, START_DATE, END_DATE,TEAM_MEMBERS_MIN, TEAM_MEMBERS_MAX) VALUES('Competición js','calificar las habilidades en js de los equipos',TO_TIMESTAMP(
    '26/11/2022 8:00am',
    'DD-MM-YYYY HH:MI'
), TO_TIMESTAMP(
    '10/12/2022 8:00pm',
...
INSERT INTO COMPETITION (NAME, DESCRIPTION,START_INSCRIPTION, END_INSCRIPTION, START_DATE, END_DATE,TEAM_MEMBERS_MIN, TEAM_MEMBERS_MAX) VALUES('Competición phyton','calificar las habilidades en phyton de los equipos',TO_TIMESTAMP(
    '15/01/2023 10:00am',
    'DD-MM-YYYY HH:MI'
), TO_TIMESTAMP(
    '17/01/2023 10:00pm',
...
INSERT INTO COMPETITION (NAME, DESCRIPTION,START_INSCRIPTION, END_INSCRIPTION, START_DATE, END_DATE,TEAM_MEMBERS_MIN, TEAM_MEMBERS_MAX) VALUES('Competición ruby','calificar las habilidades en ruby de los equipos',TO_TIMESTAMP(
    '24/09/2022 8:00am',
    'DD-MM-YYYY HH:MI'
), TO_TIMESTAMP(
    '30/09/2022 8:00pm',
...
INSERT INTO COMPETITION (NAME, DESCRIPTION,START_INSCRIPTION, END_INSCRIPTION, START_DATE, END_DATE,TEAM_MEMBERS_MIN, TEAM_MEMBERS_MAX) VALUES('Competición icesos','calificar las habilidades en programación competitiva de los equipos',TO_TIMESTAMP(
    '04/05/2022 8:00am',
    'DD-MM-YYYY HH:MI'
), TO_TIMESTAMP(
    '06/05/2022 8:00pm',
...
INSERT INTO COMPETITION (NAME, DESCRIPTION,START_INSCRIPTION, END_INSCRIPTION, START_DATE, END_DATE,TEAM_MEMBERS_MIN, TEAM_MEMBERS_MAX) VALUES(‘Competición Rstudio','calificar las habilidades en Rstudio de los equipos',TO_TIMESTAMP(
    '13/05/2023 8:00am',
    'DD-MM-YYYY HH:MI'
), TO_TIMESTAMP(
    '15/05/2023 8:00pm',
...
INSERT INTO COMPETITION (NAME, DESCRIPTION,START_INSCRIPTION, END_INSCRIPTION, START_DATE, END_DATE,TEAM_MEMBERS_MIN, TEAM_MEMBERS_MAX) VALUES('Competición Apps Móviles','calificar las habilidades de los equipos en la creación de aplicaciones móviles',TO_TIMESTAMP(
    '26/11/2023 8:00am',
    'DD-MM-YYYY HH:MI'
), TO_TIMESTAMP(
    '27/11/2023 8:00pm',
...
INSERT INTO COMPETITION (NAME, DESCRIPTION,START_INSCRIPTION, END_INSCRIPTION, START_DATE, END_DATE,TEAM_MEMBERS_MIN, TEAM_MEMBERS_MAX) VALUES('Competición C#','calificar las habilidades en C# de los equipos',TO_TIMESTAMP(
    '04/05/2023 8:00am',
    'DD-MM-YYYY HH:MI'
), TO_TIMESTAMP(
    '10/05/2023 8:00pm',
...
INSERT INTO COMPETITION (NAME, DESCRIPTION,START_INSCRIPTION, END_INSCRIPTION, START_DATE, END_DATE,TEAM_MEMBERS_MIN, TEAM_MEMBERS_MAX) VALUES('Competición js y html','calificar las habilidades en js y html de los equipos',TO_TIMESTAMP(
    '17/01/2023 8:00am',
    'DD-MM-YYYY HH:MI'
), TO_TIMESTAMP(
    '20/01/2023 8:00pm',
